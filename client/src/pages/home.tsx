  ...
  return (
    <div className="bg-gray-50 font-inter min-h-screen">
      ...
      <header className="pt-8 pb-4">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Discover the mystical power of protection with our exclusive collection of 3,333 unique Eye of Nazar NFTs. 
            Each piece carries ancient wisdom and modern artistry.
          </p>
        </div>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-8">
        ...
        <div className="mb-12 animate-float">
          ...
          >
            ...
            <circle cx="150" cy="150" r="140" fill="#DBEAFE" stroke="#3B82F6" strokeWidth="4"/>
            ...
            <g stroke="#3B82F6" strokeWidth="2" opacity="0.6">
              ...
              <line x1="61.2" y1="61.2" x2="82.8" y2="82.8" strokeLinecap="round"/>
              <line x1="217.2" y1="217.2" x2="238.8" y2="238.8" strokeLinecap="round"/>
              <line x1="238.8" y1="61.2" x2="217.2" y2="82.8" strokeLinecap="round"/>
              <line x1="82.8" y1="217.2" x2="61.2" y2="238.8" strokeLinecap="round"/>
            </g>
            
            {/* Animated pulse ring */}
            <circle cx="150" cy="150" r="120" fill="none" stroke="#60A5FA" strokeWidth="1" opacity="0.3" className="animate-pulse-slow"/>
          </svg>
        </div>
        ...
        <div className="text-center mb-8">
          ...
          <button 
            onClick={handleMint}
            className="sparkle-effect bg-gradient-to-r from-nazar-deep to-nazar-blue hover:from-nazar-blue hover:to-nazar-light 
                       text-white font-bold py-4 px-12 md:py-5 md:px-16 rounded-2xl text-lg md:text-xl 
                       transition-all duration-300 transform hover:scale-105 hover:shadow-2xl 
                       shadow-lg active:scale-95 relative overflow-hidden"
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-12">
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-nazar-tint">
            ...
            <p className="text-sm text-gray-600">Ancient symbol of protection against negative energy</p>
          </div>
          
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-nazar-tint">
            <div className="text-3xl mb-3">✨</div>
            <h3 className="font-semibold text-gray-800 mb-2">Unique Art</h3>
            <p className="text-sm text-gray-600">Hand-crafted digital art with mystical properties</p>
          </div>
          
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-nazar-tint">
            <div className="text-3xl mb-3">🌟</div>
            <h3 className="font-semibold text-gray-800 mb-2">Exclusive Access</h3>
            <p className="text-sm text-gray-600">Join our community of protection seekers</p>
          </div>
        </div>
      </main>
      ...
      <footer className="py-8 text-center text-gray-500 text-sm">
        <p>© 2024 Eye of Nazar NFTs. All rights reserved.</p>
        <p className="mt-2">Built with mystical energy and modern technology 🧿</p>
      </footer>
    </div>
  );
}
